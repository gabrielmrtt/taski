...
type ListProjectTaskCategoriesRequest struct {
...
func (r *ListProjectTaskCategoriesRequest) FromQuery(ctx *gin.Context) error {
	schemaDecoder := schema.NewDecoder()
	schemaDecoder.IgnoreUnknownKeys(true)
	return schemaDecoder.Decode(r, ctx.Request.URL.Query())
}

func (r *ListProjectTaskCategoriesRequest) ToInput() projectservice.ListProjectTaskCategoriesInput {
	...
	return projectservice.ListProjectTaskCategoriesInput{
