...
// @Router /organization/:organization_id/workspace [get]
...
// @Failure 500 {object} core_http.HttpErrorResponse
// @Router /organization/:organization_id/workspace/:workspace_id [get]
...
// @Failure 403 {object} core_http.HttpErrorResponse
// @Failure 500 {object} core_http.HttpErrorResponse
// @Router /organization/:organization_id/workspace [post]
...
// @Failure 404 {object} core_http.HttpErrorResponse
// @Failure 500 {object} core_http.HttpErrorResponse
// @Router /organization/:organization_id/workspace/:workspace_id [put]
...
// @Failure 404 {object} core_http.HttpErrorResponse
// @Failure 500 {object} core_http.HttpErrorResponse
// @Router /organization/:organization_id/workspace/:workspace_id [delete]
...
func (c *WorkspaceController) ConfigureRoutes(group *gin.RouterGroup) *gin.RouterGroup {
	g := group.Group("/organization/:organization_id/workspace")
	{
		...
		g.GET("/:workspace_id", organization_http_middlewares.UserMustHavePermission("workspaces:view"), workspace_http_middlewares.UserMustBeInWorkspace(), c.GetWorkspace)
		g.POST("", organization_http_middlewares.UserMustHavePermission("workspaces:create"), c.CreateWorkspace)
		g.PUT("/:workspace_id", organization_http_middlewares.UserMustHavePermission("workspaces:update"), workspace_http_middlewares.UserMustBeInWorkspace(), c.UpdateWorkspace)
		g.DELETE("/:workspace_id", organization_http_middlewares.UserMustHavePermission("workspaces:delete"), workspace_http_middlewares.UserMustBeInWorkspace(), c.DeleteWorkspace)
	}
