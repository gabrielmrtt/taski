...
const (
	...
	TaskActionTypeUpdateSubTask     TaskActionType = "sub_task_updated"
	...
	TaskActionTypeUncomplete        TaskActionType = "task_uncompleted"
	TaskActionTypeSubTaskUncomplete TaskActionType = "sub_task_uncompleted"
)
