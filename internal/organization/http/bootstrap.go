...
func BootstrapControllers(g *gin.RouterGroup) {
	...
	organizationUserController := NewOrganizationUserController(listOrganizationUsersService, inviteUserToOrganizationService, removeUserFromOrganizationService, acceptOrganizationUserInvitationService, refuseOrganizationUserInvitationService)
