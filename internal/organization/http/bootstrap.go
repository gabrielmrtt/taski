...
func BootstrapControllers(g *gin.RouterGroup) {
	...
	updateOrganizationUserService := organization_services.NewUpdateOrganizationUserService(organizationRepository, organizationUserRepository, roleRepository, workspaceRepository, projectRepository, workspaceUserRepository, projectUserRepository, transactionRepository)
